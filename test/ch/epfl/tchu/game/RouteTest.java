...
class RouteTest {
    ...
    /*
    @Test
    void lengthOfPossibleClaimCards(){
        Station station1 = new Station(1, "Station1");
        Station station2 = new Station(2, "Station2");
        Route route1 = new Route("1", station1, station2, 3, OVERGROUND, Color.BLUE);
        Route route2 = new Route("2", station1, station2, 3, OVERGROUND, null);
        Route route3 = new Route("3", station1, station2, 3, UNDERGROUND, Color.BLUE);
        Route route4 = new Route("4", station1, station2, 2, UNDERGROUND, null);
        assertEquals(1, route1.possibleClaimCards().size());
        assertEquals(8, route2.possibleClaimCards().size());
        assertEquals(4, route3.possibleClaimCards().size());
        assertEquals(17, route4.possibleClaimCards().size());
    }
    /*


    @Test
    void isAdditionalClaimCardsOK() {
        List<Card> claimCardsList = {new Card(Color.BLUE)}
    }
